...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return initWhereCanBuy; });\nfunction initWhereCanBuy() {\n  var links = document.querySelectorAll(\".fade-out-tab-menu__link\");\n\n  if (links) {\n    links.forEach(function (link) {\n      link.addEventListener(\"click\", function (e) {\n        e.preventDefault(); // eslint-disable-next-line no-shadow\n\n        links.forEach(function (link) {\n          link.classList.remove(\"fade-out-tab-menu__link_clicked\");\n        });\n        e.target.classList.toggle(\"fade-out-tab-menu__link_clicked\");\n        var currentProductToShow = e.target.dataset.product;\n        var products = document.querySelectorAll(\".fade-out-tab__section\");\n        products.forEach(function (product) {\n          product.classList.remove(\"fade-out-tab__section_active\");\n        });\n        products.forEach(function (product) {\n          if (product.dataset.product === currentProductToShow) {\n            product.classList.toggle(\"fade-out-tab__section_active\");\n          }\n        });\n      });\n    });\n  }\n}\n\n//# sourceURL=webpack:///./src/js/where-can-buy.js?");
